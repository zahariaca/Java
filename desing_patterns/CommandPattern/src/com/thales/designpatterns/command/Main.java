...
public class Main {
	...
	public static void main(String[] args) {
	    ...
	    SwitchCommand switchCommand3 = new SwitchCommand(track1);
	    SwitchCommand switchCommand4 = new SwitchCommand(track2);
		...
		commandMenu.addCommand(switchCommand3);
		commandMenu.addCommand(switchCommand2);
		commandMenu.addCommand(switchCommand4);
